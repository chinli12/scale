                              ...
                              StreamBuilder<List<SchoolRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: listViewSchoolRecordList.length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewSchoolRecord =
                                          listViewSchoolRecordList[
                                              listViewIndex];
                                      return Visibility(
                                        visible: functions.seach(
                                                listViewSchoolRecord.title,
                                                listViewSchoolRecord.title) ??
                                            true,
                                        child: Padding(
                                          padding:
