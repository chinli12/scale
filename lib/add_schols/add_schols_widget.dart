...
import 'add_schols_model.dart';
export 'add_schols_model.dart';

class AddScholsWidget extends StatefulWidget {
  const AddScholsWidget({Key? key}) : super(key: key);

  @override
  _AddScholsWidgetState createState() => _AddScholsWidgetState();
}

class _AddScholsWidgetState extends State<AddScholsWidget> {
  late AddScholsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddScholsModel());
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        if ((_model.textController1.text != null && _model.textController1.text != '') &&
                                          ...
                                          await _model.schole!.reference
                                              .update(createSchoolRecordData(
                                            id: _model.schole?.reference.id,
                                          ));
