...
import 'coursedetail_model.dart';
export 'coursedetail_model.dart';
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<CourseRecord>(
            stream: CourseRecord.getDocument(widget.corse!),
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            stream: queryCourseSectionRecord(
                                              queryBuilder:
                                                  (courseSectionRecord) =>
                                                      courseSectionRecord.where(
                                                'course_id',
                                                isEqualTo: widget.corse,
                                              ),
                                            ),
                                            builder: (context, snapshot) {
                                              // Customize what your widget looks like when it's loading.
                                              ...
                                              List<CourseSectionRecord>
                                                  listViewCourseSectionRecordList =
                                                  snapshot.data!;
                                              return ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  final listViewCourseSectionRecord =
                                                      listViewCourseSectionRecordList[
                                                          listViewIndex];
                                                  return Padding(
                                                    padding:
